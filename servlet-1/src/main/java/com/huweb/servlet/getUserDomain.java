...
public class getUserDomain extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (user1.getUsername().equals("root"))dis = request.getRequestDispatcher("/jsp/manager.jsp");
        else if (user1.getUsername()==null)dis = request.getRequestDispatcher("/jsp/error.jsp");
